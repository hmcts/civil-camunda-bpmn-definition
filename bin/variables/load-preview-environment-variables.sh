...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://ccd-definition-store-civil-camunda-pr-${pr}.preview.platform.hmcts.net"
echo "export CAMUNDA_BASE_URL=https://camunda-civil-camunda-pr-${pr}.preview.platform.hmcts.net"

# definition placeholders
echo "export CCD_DEF_CASE_SERVICE_BASE_URL=http://civil-camunda-pr-${pr}-java"
echo "export CCD_DEF_GEN_APP_SERVICE_BASE_URL=http://ga-civil-camunda-pr-${pr}.preview.platform.hmcts.net"

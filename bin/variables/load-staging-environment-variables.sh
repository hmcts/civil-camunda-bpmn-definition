...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://ccd-definition-store-civil-damages-camunda-bpmn-definition-staging.service.core-compute-preview.internal"
echo "export CAMUNDA_BASE_URL=https://camunda-civil-damages-camunda-bpmn-definition-staging.service.core-compute-preview.internal"

# definition placeholders
echo "export CCD_DEF_CASE_SERVICE_BASE_URL=http://civil-damages-camunda-bpmn-definition-staging.service.core-compute-aat.internal"

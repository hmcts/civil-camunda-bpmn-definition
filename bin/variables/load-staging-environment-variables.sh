...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://ccd-definition-store-civil-damages-camunda-staging.service.core-compute-preview.internal"
echo "export CAMUNDA_BASE_URL=https://camunda-civil-damages-camunda-staging.service.core-compute-preview.internal"

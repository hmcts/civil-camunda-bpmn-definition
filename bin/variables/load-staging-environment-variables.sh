...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://civil-camunda-definition-store-staging-aat.service.core-compute-aat.internal"
echo "export CAMUNDA_BASE_URL=https://civil-camunda-camunda-staging-aat.service.core-compute-aat.internal"

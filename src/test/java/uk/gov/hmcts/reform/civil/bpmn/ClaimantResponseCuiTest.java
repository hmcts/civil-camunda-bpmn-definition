...
public class ClaimantResponseCuiTest extends BpmnBaseTest {
    ...
    private void createClaimantDashboardNotificationForJOIssued() {
        assertCompletedCaseEvent(CREATE_DASHBOARD_NOTIFICATION_JUDGEMENT_BY_ADMISSION_CLAIMANT, CREATE_DASHBOARD_NOTIFICATION_JUDGEMENT_BY_ADMISSION_CLAIMANT_EVENT_ID);
    }

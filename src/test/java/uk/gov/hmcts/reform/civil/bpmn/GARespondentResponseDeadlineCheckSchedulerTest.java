...
public class GARespondentResponseDeadlineCheckSchedulerTest extends BpmnBaseTest {

    public static final String TOPIC_NAME = "GARespondentResponseCheckScheduler";

    public GARespondentResponseDeadlineCheckSchedulerTest() {
        super("general_application_respondent_response_deadline_check_scheduler.bpmn", "GA_RESPONDENT_RESPONSE_DEADLINE_CHECK_SCHEDULER");
    }

...
class ResendNotifyRPASchedulerTest extends BpmnBaseTest {

    public static final String TOPIC_NAME = "RESEND_NOTIFY_RPA_EVENTS";

    public ResendNotifyRPASchedulerTest() {
        super("resend_notify_rpa_events_scheduler.bpmn", "RESEND_NOTIFY_RPA_SCHEDULER");
    }

...
public class RetriggerRespondent1CaseFlagSchedulerTest extends BpmnBaseTest {

    public static final String TOPIC_NAME = "RETRIGGER_CASE_FLAG_EVENT";

    public RetriggerRespondent1CaseFlagSchedulerTest() {
        super("defendent_case_flag_scheduler.bpmn", "DEFENDENT_CASE_FLAG_SCHEDULER");
    }

    @Test
    void testDefendentCaseFlagReStoreProcess() throws ParseException {
